...
public class KiwoomTradingService extends KiwoomApiService{
    ...
    //매수
    public String fn_kt10000(String dmst_stex_tp, String stk_cd, String ord_qty, String ord_uv, String trde_tp, String cond_uv) {
    ...
    //매도
    public String fn_kt10001(String dmst_stex_tp, String stk_cd, String ord_qty, String ord_uv, String trde_tp, String cond_uv) {
        String jsonData = String.format(
                "{\"dmst_stex_tp\":\"%s\",\"stk_cd\":\"%s\",\"ord_qty\":\"%s\",\"ord_uv\":\"%s\",\"trde_tp\":\"%s\",\"cond_uv\":\"%s\"}",
                dmst_stex_tp, stk_cd, ord_qty, ord_uv, trde_tp, cond_uv
        );
    ...
    //주문정정
    public String fn_kt10002(String dmst_stex_tp, String orig_ord_no, String stk_cd, String mdfy_qty, String mdfy_uv, String mdfy_cond_uv) {
        String jsonData = String.format(
        ...
        return callKiwoomAPI("/api/dostk/ordr", "kt10002", jsonData);
    }

    //주문취소
    public String fn_kt10003(String dmst_stex_tp, String orig_ord_no, String stk_cd, String cncl_qty) {
        String jsonData = String.format(
