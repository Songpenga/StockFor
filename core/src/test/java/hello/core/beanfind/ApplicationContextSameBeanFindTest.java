...
/*    @Test
    ...
    void findBeanByTypeDuplicate(){
        ...
        //        No qualifying bean of type 'hello.core.MemberInfo.MemberRepository' available:
    ...
    void findBeanByName(){
        MemberRepository memberRepository = app.getBean("memberRepository1", MemberRepository.class);
    ...
    void findAllBeanByType(){
        Map<String, MemberRepository> beansOfType = app.getBeansOfType(MemberRepository.class);
        for (String keySet : beansOfType.keySet()) {
            System.out.println("key = " + keySet + "val = " + beansOfType.get(keySet));
        }
